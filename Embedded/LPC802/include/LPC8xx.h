...
typedef struct
{
  ...
  __IO uint32_t RESERVED4[2]        ; ///< (0x05C - 0x060)
...
//------------- PLU ----------------
#define NUM_LUTS 26
#define GAP1 ((0x800 - 4*((8*NUM_LUTS)-1)) / 4) - 1
#define GAP2 ((0x900 - (0x800 + 4*(NUM_LUTS-1))) / 4) - 1

typedef struct {
  __IO uint32_t INP0_MUX;
  __IO uint32_t INP1_MUX;
  __IO uint32_t INP2_MUX;
  __IO uint32_t INP3_MUX;
  __IO uint32_t INP4_MUX;
  __I  uint32_t reserved[3];
} LPC_PLU_INREG_T;

typedef struct {                       
  LPC_PLU_INREG_T LUT[NUM_LUTS];       // 0x000 - 0x33C = 0x0 through (26x8 - 1)*4 = (0x1Ax8 - 1)*4 = 0x33C
  __I  uint32_t reserved1[GAP1];       // 0x340 - 0x7FC   304 = (0x800 - 0x340)/4 
  __IO uint32_t LUT_TRUTH[NUM_LUTS];   // 0x800 - 0x864
  __I  uint32_t reserved2[GAP2];       // 0x868 - 0x8FC   38
  __O  uint32_t OUTPUTS;               // 0x900
  __I  uint32_t reserved3[191];        // 0x904 - 0xBFC
  __IO uint32_t OUTPUT_MUX[8];         // 0xC00 - 0xC1C 
} LPC_PLU_TypeDef;
